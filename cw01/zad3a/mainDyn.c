...
int main(int argc, char **argv)
{
    ...
    removeBlock = dlsym(handle, "removeBlock");
    removeOperation = dlsym(handle, "removeOperation");
    removeArray = dlsym(handle, "removeArray");
    compareListOfTwoFiles = dlsym(handle, "compareListOfTwoFiles");
